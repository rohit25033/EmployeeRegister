...
export const qsrRegistrations = pgTable("qsr_registrations", {
  ...
  gstCertificateUrl: text("gst_certificate_url").notNull(),
  fssaiCertificateUrl: text("fssai_certificate_url").notNull(),
  businessRegistrationProofUrl: text("business_registration_proof_url").notNull(),
  panCardUrl: text("pan_card_url").notNull(),
  bankAccountProofUrl: text("bank_account_proof_url").notNull(),
